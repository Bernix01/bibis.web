                                    ...
                                    <td>
                                        <table class="style4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_fecha_emision" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_fecha_vencimiento" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <table class="style4">
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox ID="txt_cedula_vendedor" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:ImageButton ID="btn_buscar_vendedor" runat="server" CssClass="style18"
                                                                    Height="24px"
                                                                    ImageUrl="C:\Users\usuario\Desktop\ali factura\bibis\imagenes\BUSCAR.gif"
                                                                    Width="25px" />
                                                                <br />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_vendedor" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
